...
example spec file is [here](https://github.com/koyashiro/md2xlsx/blob/develop/example/spec.md).

### Convert to xlsx

```sh
md2xlsx -o output.xlsx spec.md
```
